...
<h3>ENTER YOUR REGISTER NO:212224230085</h3>
<h3>EX. NO:3</h3>
...
<img width="265" height="190" alt="catimages" src="https://github.com/user-attachments/assets/9c0736af-2f3b-43be-bc1c-9f24ac291ae5" />


## Edge Detection image:
<img width="265" height="190" alt="image" src="https://github.com/user-attachments/assets/8112b845-0a81-460b-a371-a3e034d7736f" />



## RESULT:
Thus the program has been executed by using CUDA to perform Sobel edge detection on an image using GPU parallel processing. The output image was generated successfully with clear edge detection, and the total execution time taken was approximately  89.918945 milliseconds.
...
Using shared memory to reduce global memory access Applying Gaussian blur before Sobel filtering to reduce noise Using constant memory for Sobel kernels Increasing occupancy with optimized block sizes Using streams for overlapping memory transfer and computation

# Deliverables:
## 1. Modified CUDA code with comments explaining changes
Added Sobel X and Sobel Y kernels Implemented GPU memory allocation and data transfer Added CUDA timing using CUDA events Added boundary checking to avoid invalid memory access Stored output image after GPU computation
...
CUDA execution was faster than CPU execution Output images were visually similar Parallel processing improved efficiency for large images

# Tools Required:
CUDA Toolkit NVIDIA GPU OpenCV Library Google Colab / Linux Environment C++ Compiler with NVCC Support Python (for displaying output images)
